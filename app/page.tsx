          ...
          >
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 pb-32 min-h-0">
              ...
              <div className="group relative p-8 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 hover:border-[#60a5fa]/30 hover:shadow-2xl hover:shadow-[#60a5fa]/20 hover:-translate-y-1 transition-all duration-300">
                <a href="https://github.com/ZaheerH-03/Modular-RAG" className="absolute top-8 right-8 text-white/40 hover:text-white transition-colors" aria-label="GitHub Link">
                ...
                <p className="text-white/60 leading-relaxed mb-6">A modular, interface-driven RAG pipeline that lets students query their course PDFs using hybrid retrieval and a locally hosted LLM — with every component swappable via a single config file.</p>
                <div className="flex flex-wrap gap-2 text-xs font-mono text-[#60a5fa]/80">
                  <span className="px-2 py-1 rounded bg-[#60a5fa]/10">RAG Pipeline</span>
                  <span className="px-2 py-1 rounded bg-[#60a5fa]/10">Modular Architecture</span>
